---
title: Overview
description: WhaleCore SDK 的能力、架構邊界與平台支援
---

WhaleCore SDK 是無 UI 的證券業務數據 SDK。Broker App 自行實作介面，透過 WhaleCore 管理客戶端工作階段、即時數據和業務服務，並以 Trading API 補充 Customer 級 HTTP 能力。
...
<CardGroup cols={2}>
  <Card title="完全自訂 UI" icon="palette">Broker 自行設計證券業務頁面和互動，不使用 WhaleApp SDK 的現成介面。</Card>
...
| 平台 | 狀態 | 指南 |
| --- | --- | --- |
| iOS | 可用，iOS 13+，Swift / Objective-C | [iOS](/zh-Hant/whalesdk/core-ios) |
| Android | 可用，Kotlin / Java | [Android](/zh-Hant/whalesdk/core-android) |
