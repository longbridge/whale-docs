...
| --- | --- | --- | --- | --- | --- |
| [WhaleApp SDK](/zh-hk/whalesdk/whaleapp/overview) | Broker App 開發團隊 | Customer | iOS / Android / WebTrade 圖形介面 SDK | 在 Broker App、網站或 Web 容器中整合完整證券業務 UI | 可用 |
| [WhaleCore SDK + Trading API](/zh-hk/trading-api/introduction) | Broker App | Customer | iOS / Android / Web 資料 SDK + HTTP API | Broker App 完全自行實現證券功能 UI | iOS / Android 可用；WebAssembly 開發中 |
| [Broker API](/zh-hk/broker-api/overview) | Broker Server / 自研管理後臺服務端 | Broker | HTTPS API | Server-to-Server 整合或自研管理後臺 | 可用 |
