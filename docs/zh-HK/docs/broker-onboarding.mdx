...
| 階段 | 指南 |
| --- | --- |
| 理解 Customer、使用者、開戶申請、帳戶和訊息的關係 | [核心物件與業務流程](/zh-hk/docs/concepts) |
| 確定 UI、客戶端和服務端方案 | [接入方式選擇](/zh-hk/docs/integration-options) |
| 確定 Customer 註冊、登入和會話歸屬 | [使用者系統接入](/zh-hk/docs/user-system-integration) |
...
- **接入邊界**：採用 WhaleAppSDK、WhaleCoreSDK + TradingAPI 或 BrokerAPI；由哪一方維護 Customer 使用者體系。
