...
| --- | --- | --- | --- | --- | --- |
| [WhaleApp SDK](/en/whalesdk/whaleapp/overview) | Broker App team | Customer | iOS / Android / WebTrade graphical SDK | Integrate a complete securities UI in Broker App, website, or web container | Available |
