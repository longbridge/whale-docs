...
Include environment, timestamp and timezone, endpoint and method, redacted request summary, HTTP status, business code, request correlation ID, impact, and whether the issue reproduces consistently. Never send secrets or complete Client-sensitive data through chat or tickets.
