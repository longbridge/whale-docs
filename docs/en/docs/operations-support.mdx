...
Each API product documents its own error model and limits. For example, see [Broker API operations](/en/broker-api/operations/).
...
## Changes and production incidents
