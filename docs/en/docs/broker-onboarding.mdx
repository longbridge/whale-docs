...
flowchart TD
    ...
    D -->|Ready-made UI| E[WhaleAppSDK]
    D -->|Implement securities UI| F[WhaleCoreSDK + TradingAPI]
    D -->|Institution-level backend| G[BrokerAPI]
...
| Goal | Guide |
| --- | --- |
| Understand Clients, users, applications, accounts, and messages | [Core objects and business flows](/en/docs/concepts) |
| Choose UI, client, and server paths | [Integration options](/en/docs/integration-options) |
| Decide Client registration, login, and session ownership | [User-system integration](/en/docs/user-system-integration) |
| Integrate a complete UI | [WhaleAppSDK for iOS, Android, and WebTrade](/en/whalesdk/whaleapp/overview) |
| Implement the securities UI in Broker App | [WhaleCoreSDK and TradingAPI](/en/trading-api/overview) |
| Integrate institution-level backend capabilities | [BrokerAPI](/en/broker-api/overview) |
...
## Phases, deliverables, and exit criteria {/* phases-deliverables-and-exit-criteria */}
...
| Broker App Developer | WhaleAppSDK (iOS, Android, or WebTrade) or WhaleCoreSDK integration |
...
| Work | Broker | Whale |
| --- | --- | --- |
| Broker product scope and Client experience | Decide and accept | Explain capability boundaries and advise implementation |
...
- **Integration boundary:** WhaleAppSDK, WhaleCoreSDK + TradingAPI, or BrokerAPI, and which party maintains the Client user system.
...
- Whether Broker App uses WhaleAppSDK (iOS, Android, or WebTrade) or WhaleCoreSDK + TradingAPI to implement the securities UI.
- Which BrokerAPI capabilities Broker Server uses.
- Who manages Client users and how `open_id` remains stable.
...
## 3. Environment and material preparation {/* 3-environment-and-material-preparation */}

### Broker provides {/* broker-provides */}
...
### Environment exit criteria {/* environment-exit-criteria */}
...
## 4. Development, integration, and acceptance {/* 4-development-integration-and-acceptance */}
...
6. Have the business team execute UAT and record acceptance.
...
## 5. Production go-live {/* 5-production-go-live */}
