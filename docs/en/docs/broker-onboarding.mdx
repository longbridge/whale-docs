...
flowchart TD
    ...
    D -->|Implement securities UI| F[WhaleCore + TradingAPI]
...
| Implement the securities UI in Broker App | [WhaleCore and TradingAPI](/en/trading-api/overview) |
...
| Broker App Developer | WhaleAppSDK (iOS, Android, or WebTrade) or WhaleCore integration |
...
- **Integration boundary:** WhaleAppSDK, WhaleCore + TradingAPI, or BrokerAPI, and which party maintains the Client user system.
...
- Whether Broker App uses WhaleAppSDK (iOS, Android, or WebTrade) or WhaleCore + TradingAPI to implement the securities UI.
