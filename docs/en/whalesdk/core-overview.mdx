---
title: Overview
description: WhaleCore SDK capabilities, boundaries, and platform support
---

WhaleCore SDK is a UI-free securities data SDK. Broker App implements its own interface, uses WhaleCore for client sessions, real-time data, and business services, and combines it with Trading API for additional Customer-scoped HTTP capabilities.
...
<CardGroup cols={2}>
  <Card title="Fully custom UI" icon="palette">Broker designs every securities screen and interaction instead of using WhaleApp SDK UI.</Card>
...
flowchart LR
    ...
    A --> F[Trading API]
    F --> G[Customer-scoped HTTP capabilities]
```

| Platform | Status | Guide |
| --- | --- | --- |
| iOS | Available; iOS 13+; Swift / Objective-C | [iOS](/en/whalesdk/core-ios/) |
| Android | Available; Kotlin / Java | [Android](/en/whalesdk/core-android/) |
