...
<CardGroup cols={2}>
  ...
  <Card title="WhaleCore SDK" icon="database" href="/en/whalesdk/core-overview">
...
- [Product capabilities and example screens](/en/whalesdk/capabilities)
- [Technical FAQ and reference performance data](/en/whalesdk/technical-faq)
...
Start with the [WhaleCore SDK overview](/en/whalesdk/core-overview), then follow the [iOS](/en/whalesdk/core-ios) or [Android](/en/whalesdk/core-android) guide.
