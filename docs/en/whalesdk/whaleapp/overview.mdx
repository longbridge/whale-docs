...
WhaleAppSDK for iOS and Android provides a complete graphical securities experience. Broker App integrates the SDK, supplies the Customer session, connects operating-system capabilities, and manages the App and SDK lifecycle.
