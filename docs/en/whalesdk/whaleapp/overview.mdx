...
Current SDK versions expose analytics-event callbacks on both platforms. Consume only events and properties agreed for the project, and do not depend on undocumented internal business events.
