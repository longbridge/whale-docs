...
## UI lifecycle callback {/* ui-lifecycle-callback */}
...
## Open pages and change presentation {/* open-pages-and-change-presentation */}
...
Call this when the Client signs out, switches accounts, or the SDK reports unrecoverable authentication failure. It closes SDK pages, stops SDK activity, and clears the current startup configuration.
...
### FCM as an Aliyun vendor channel {/* fcm-as-an-aliyun-vendor-channel */}
...
### Push-service contract {/* push-service-contract */}
