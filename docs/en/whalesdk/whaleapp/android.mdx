...
Extract `LBWhaleAppSDK-XXX.zip`, which contains the AARs and Demo, and place the SDK directory in the App module (for example, `app/`). In the App-level Gradle file, load the delivered configuration:
