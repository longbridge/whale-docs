...
## Lifecycle and authentication callbacks {/* lifecycle-and-authentication-callbacks */}
...
### Exceptional renewal fallback {/* exceptional-renewal-fallback */}
...
## UI lifecycle and external URLs {/* ui-lifecycle-and-external-urls */}
...
### Orientation forwarding {/* landscape-support */}
...
### Configuration objects and delegates {/* configuration-objects-and-delegates */}
...
### Push-service declarations {/* push-service-declarations */}
...
### Analytics callback {/* analytics-callback */}
...
Forward only event names and properties agreed for the project. Never add credentials or Client-sensitive information.
