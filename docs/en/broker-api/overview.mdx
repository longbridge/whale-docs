...
<Warning>
BrokerAPI is still under construction. Use this documentation to understand the capability scope and plan an integration, but treat paths, fields, and availability as subject to change rather than as the final published contract. Building directly against the current documentation may require rework. Confirm the current status and approved scope of the operations you need with the Whale project team before you start development.
</Warning>
