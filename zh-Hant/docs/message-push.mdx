...
| 客戶端工作 | 註冊裝置，並將推送訊息交給 WhaleSDK | 註冊自有渠道，並將標準訊息體交給 WhaleSDK |
...
5. Broker App 完成系統通知許可權、裝置 token 註冊和 WhaleSDK 訊息處理。
...
sequenceDiagram
    ...
    participant App as Broker App / WhaleSDK
...
| `user_info` | 客戶端透傳資料 | 推送到 App 後原樣交給 WhaleSDK |
...
無論選擇哪一種服務端路徑，最終交給 WhaleSDK 的訊息結構一致：
