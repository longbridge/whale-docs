...
WhaleSDK 支援兩種訊息對接方案。兩種方案最終都由 Broker App 接收標準訊息體並交給 WhaleSDK，區別在於訊息由 Whale 直接投遞到雲推送渠道，還是先轉發給 Broker Server。
...
<Steps>
  ...
  <Step title="整合 Broker App">
    Broker App 對接 WhaleSDK 訊息 API，並驗證通知許可權、裝置 token、前後臺接收和點選跳轉。
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="整合 Broker App">
    Broker App 將最終收到的標準訊息體交給 WhaleSDK，並完成安全跳轉和相容處理。
  </Step>
</Steps>
