...
<p>如客户是提供了多个国藉证件，取的证件号逻辑顺序是：香港身份证＞本国身份证＞护照，按香港交易所申报 BCAN 的顺序保持一致。</p>
</div>
...
<div class="callout callout-bg-5 callout-border-5 callout-color-1">
<div class='callout-emoji'>🎁</div>
<p>如果客户没钱没货就不能创建出临时结单／ 月结单，没有流水出入记录没有日结单。</p>
</div>
...
<div class="callout callout-bg-5 callout-border-5 callout-color-1">
<div class='callout-emoji'>🎁</div>
<p>如：交易总额为 <code>$500,000</code>、数量为 <code>5,000</code>。总成本价输入 <code>$500,000</code>、结单上的成本价以摊薄成本价显示 <code>= ＄100</code></p>
</div>
