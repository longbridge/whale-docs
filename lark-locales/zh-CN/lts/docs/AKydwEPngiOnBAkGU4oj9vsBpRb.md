...
<img src="L3mybtuW1oiuBkxl8ysjUtpvpue" src-width="2746" src-height="462" align="center"/>

<img src="QbSnbEl5DoWKO5xF9zHjT30vpAg" src-width="634" src-height="598" align="center"/>
...
3. 功能模块概述
    <img src="WPDCbKBPdoxA6rxvmLNjHM2ip9b" src-width="2634" src-height="914" align="center"/>
...
<img src="PuFabCnfEoS7KRxDGuOjRbgdpkX" src-width="1374" src-height="922" align="center"/>

<img src="Fz4TbzbZAogeunxjv3QjYo1ApXb" src-width="1376" src-height="940" align="center"/>
...
1. 客户信息组件横排、竖排样式切换
    - 客户信息组件支持切换横排 / 竖排样式，可通过右上角“···”快速切换使用！
        ...
        - 竖向排列样式占位面积相对较大，建议新开标签页进行使用，如在交易面板中进行切换可能会导致信息展示不全
            <img src="AYFsblIayodvIAxWcKajE6mKpcd" src-width="2746" src-height="528" align="center"/>
            <img src="UZyMbb948ofILlxSRrejTssypOe" src-width="2846" src-height="1590" align="center"/>
        - 竖向排列样式设置功能说明：
            <img src="Rpb9bpLVOoRJLWxH4LVjEGyDpue" src-width="2128" src-height="800" align="center"/>
