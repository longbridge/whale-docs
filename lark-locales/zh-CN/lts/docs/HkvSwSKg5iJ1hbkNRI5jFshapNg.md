...
|HKD|USD|7.8147|7.8132|
        ...
        <tbody>
        <tr><td><p><b>加点方式</b></p></td><td><p><b>USD兑换CNH加点值</b></p></td></tr>
        <tr><td><p>比值 0.001</p></td><td><p>=USD兑换CNH未加点的参考汇率-比值=7.1367-0.001=7.1366</p></td></tr>
        <tr><td><p>比率 0.1%</p></td><td><p>=USD兑换CNH未加点的参考汇率（1-比率）=7.1367（1-0.1%）=7.1295</p></td></tr>
        </tbody>
        </table>
    - 「成交汇率」上设定加点数值：
...
详细操作顺序，可参考[快速上手 ✅](YUOCdChA8ovy21xCwETjErLmpYb)描述
