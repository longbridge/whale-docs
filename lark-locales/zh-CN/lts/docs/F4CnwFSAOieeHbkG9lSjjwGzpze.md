...
<img src="TUambKCm8owhAGx4veujeMLTpUh" src-width="2940" src-height="738" align="center"/>
...
<img src="ShmgbBWaOoi7xPxNEIRjH0pZpue" src-width="2074" src-height="1000" align="center"/>
...
- 修改：若在提交入金申请前，发现客户递交的某笔入金申请有问题，可在与客户确认无误后可以透过【编辑】按钮进行修正，修改后需进行工单审批，审批通过后修改内容生效。
    <img src="JJc1bPTaRoOoFFx9iepjvxOjpVe" src-width="2076" src-height="998" align="center"/>
...
<img src="ScyRby2E3oLJX5xuP6ejlcgLp6S" src-width="1678" src-height="1764" align="center"/>

无需审批

<img src="OE7KbRAjToBMBYxjx38jan8Ypse" src-width="1688" src-height="1754" align="center"/>
...
<img src="AjoebS1tLoumPtxvOVtjZLI1p6d" src-width="3818" src-height="1842" align="center"/>

<img src="YIAtbP6S4o2cevxWt9GjlVq2pzh" src-width="3904" src-height="1950" align="center"/>

```text
- 如系统预设匹配的用户不准，可透过【自定义】手动关联该笔银行流水所对应的客户。关联的方式有：入金的申请与证券帐号
```

<img src="TBpgbcEFUozISUxccdpjbuVFpcg" src-width="3308" src-height="1776" align="center"/>

<img src="XAzEbmIDcogUT3x0gf7jrpgCpIe" src-width="3308" src-height="1750" align="center"/>

入金退还：若因种种原因，导致入金未能正常进入客户的证券帐户，需要对这笔记录进行退款时，可以使用该功能进行操作。用户需填写客户的银行卡讯息，确认无误后点选【确定】流转至入金审核页面进行审核操作。

<img src="NryQbXcMGoFJVyxBEdMjge96pjc" src-width="2436" src-height="1326" align="center"/>

出金退还：由于入金匹配页面的数据来自银行流水流入的信息，如果用户在处理客户出金的时候被银行拒绝，在银行流水中会以流入的形式存在，用户需要关联出金的业务流水号通过【出金退还】功能处理此类记录。

<img src="XXvmbr0PuoGCrdx06NKjDsGJpmh" src-width="2366" src-height="1234" align="center"/>
...
<img src="UV59bZvGXoRgqKxmBADj3r43pEh" src-width="3334" src-height="1598" align="center"/>

- 已开户：选取目标记录后，点选【审批】后进入详情页面再次核对讯息，确认无误后审核通过

<img src="CraHbYLHwof34wxnp44j8L3op7c" src-width="3318" src-height="1598" align="center"/>

- 入金退还：选取目标记录后，点选【审批】后唤出审批工单，确认资讯无误后审核通过

<img src="T3zWbyL0qowzTzxrD5wjffgqpWh" src-width="3330" src-height="1596" align="center"/>

- 出金退还：选取目标记录后，点选【审批】后确认无误后直接通过，无需走工单审批流程

<img src="B9n0bJprMoyhv5xal1XjCnCkpZQ" src-width="3318" src-height="1598" align="center"/>
...
<img src="QZpybEAWGoxf33xEXC2jgiGBpwb" src-width="3392" src-height="1693" align="center"/>
...
<img src="WZ9wbbV1XorUCDxQUZAjpmeOpxf" src-width="3336" src-height="1770" align="center"/>

<img src="VGi7bwdyYouB3qxyIAGjDht5pDf" src-width="3828" src-height="1870" align="center"/>
...
<img src="SwjfbI4ofoNeiix94A1j3zXrpIf" src-width="3816" src-height="1854" align="center"/>
