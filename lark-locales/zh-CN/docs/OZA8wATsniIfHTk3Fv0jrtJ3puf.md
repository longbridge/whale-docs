...
本使用手册适用于 Longbridge Whale-权益平台， 运营系统管理员和使用成员使用。阅读此手册，你将了解Whale-权益平台作业功能操作
...
如果订阅了whale的内容服务中的行情内容，则可以将行情查看权限售卖给用户，目前whale的工作人员会帮助每一位租户创建和管理行情商品，在此不做过多说明
