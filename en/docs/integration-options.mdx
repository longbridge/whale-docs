...
| [Broker API](/en/broker-api/overview) | Broker Server | Broker | Server-to-Server API | Institution-level data and SaaS back-office capabilities | Available |
...
- **Broker-scoped authorization:** institution-level backend integrations use Broker API.
