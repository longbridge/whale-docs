...
**Whale Console**:
供 Broker 柜台操作人员使用的后台产品，以及该产品对应的操作手册与任务指引栏目。
_Avoid_: Admin Portal、Back Office、Operation Guide（作为产品或栏目名称时）
...
**Broker Operator**:
代表 Broker 在 Whale Console 执行日常柜台业务、审核、配置、查询和异常处理的操作人员。
