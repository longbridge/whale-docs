/*
 * read lark-pages/docs.json loop each children generate siderbar config
 * config example:
  sidebar: [
    {
      text: '简体中文',
 ...
 * */
  import docsMeta from "../lark-pages/zh-HK/docs.json"
  import docsCnMeta from "../lark-pages/zh-CN/docs.json"
  import docsEnMeta from "../lark-pages/en/docs.json"
