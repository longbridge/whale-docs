...
Message Settings is a proprietary Whale WBO system feature that enables brokerage operations personnel to issue specific message notifications for the scenarios below, facilitating real-time message notification management.

Scenario 1: To-Do Notifications (Workflow / Task-Based)

1. Certain approvals or workflow node reviews can notify a specific WBO backend user or any user with the required permissions.
2. Task reminders.
...
1. Example: Exchange rate import operation reminders.
2. Example: Manual settlement operation reminders.
...
- (System 01/30: New feature) To provide more message notifications, the system has been optimized to add the following business alert message types:
    - New email alert management for daily successful execution of accounting entries.
    - New email alert management for bank statement balance reconciliation.
    - New email alert management for successful entry rerun results.
    - New email alert management for failed entry rerun tasks.
