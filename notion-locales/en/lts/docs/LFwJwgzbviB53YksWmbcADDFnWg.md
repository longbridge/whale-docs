...
When a user encounters exceptional circumstances, traders may temporarily increase or decrease a client's assets to allow the client to complete an order first; the funds or securities will subsequently be invalidated.

Temporary account adjustments currently support cash, equities, and options.
