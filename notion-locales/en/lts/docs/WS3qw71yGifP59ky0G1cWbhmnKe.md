...
The Whale Accounting Middle Platform fully supports brokerage securities business accounting processes, including end-to-end management of accounting parameters, accounting entries, account balances, account detail ledgers, and accounting data sources.

For brokerage securities business, once the accounting parameters have been configured, the system supports automatic retrieval of data sources and the generation of accounting entries for exportable reports.
...
### Account Attribute Configuration

Before using the Accounting Middle Platform, brokers must configure account attributes.

<b>Step 1: View Account Attributes</b>
...
Each brokerage firm can customize its chart of accounts.
...
Each brokerage firm can customize journal entry rules.
...
Each brokerage firm can define fund types.
...
Each brokerage firm can customize aggregation rules according to export report requirements.
...
Each brokerage firm can personalize configurations according to whether accounting is required.
...
After brokerage securities transactions occur, the system will generate accounting results based on the accounting parameters for users to query and export.
