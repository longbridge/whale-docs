...
| 费率           | 是        | 代表客户选择此方式认购时，所匹配的费率套餐 所选费率只能为[费率管理](./NCxvwUuDfiJJ66kgmcrcCUVunYg)预设好的费率                                                                                                                                                                           |       |
...
| 费率         | 是        | 代表客户选择此方式认购时，所匹配的费率套餐 所选费率只能为[费率管理](/2305bab0c2cc80a2b5c1c4a7b99396a2)预设好的费率 |
| 认购开始时间     | 是        | 开始认购的时间                                                                      |
| 结束时间       | 是        | 截止认购的时间                                                                      |
