...
| **权限名称**                                   | **权限说明**                                                |
| ------------------------------------------ | ------------------------------------------------------- |
| 使用运营计划、人群画像、触达通道的权限 DeliverySystemReadOnly | 增删改查个人名下运营计划；创建、管理、查看用户分群； 增删改查Banner、弹窗、Push、SMS、Email |
...
配置条件如下：已开户用户 且 最近 App 启动时间在2022-12-01 至 2023-01-31
...
![Push内容示例](/assets/837f003e19c13fe9f33bc3574183e271.png)
